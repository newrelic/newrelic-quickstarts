...
### <a name="autogenerated_heading_2"></a>4.1. root > authors > authors items
...
#### <a name="authors_items_anyOf_i0"></a>4.1.1. Property `root > authors > authors items > anyOf > The first anyOf schema`
...
| Each item of this array must be           | Description |
| ----------------------------------------- | ----------- |
| [installPlans items](#installPlans_items) | -           |
|                                           |             |

### <a name="autogenerated_heading_3"></a>5.1. root > installPlans > installPlans items
...
#### <a name="installPlans_items_anyOf_i0"></a>5.1.1. Property `root > installPlans > installPlans items > anyOf > The first anyOf schema`
...
### <a name="autogenerated_heading_4"></a>8.1. root > keywords > keywords items
...
#### <a name="keywords_items_anyOf_i0"></a>8.1.1. Property `root > keywords > keywords items > anyOf > The first anyOf schema`
...
| Each item of this array must be           | Description |
| ----------------------------------------- | ----------- |
| [contributors items](#contributors_items) | -           |
|                                           |             |

### <a name="autogenerated_heading_5"></a>10.1. root > contributors > contributors items
...
#### <a name="contributors_items_anyOf_i0"></a>10.1.1. Property `root > contributors > contributors items > anyOf > The first anyOf schema`
...
##### <a name="contributors_items_anyOf_i0_github-username"></a>10.1.1.1. Property `root > contributors > contributors items > anyOf > The first anyOf schema > github-username`
...
##### <a name="contributors_items_anyOf_i0_profile-url"></a>10.1.1.2. Property `root > contributors > contributors items > anyOf > The first anyOf schema > profile-url`
...
##### <a name="contributors_items_anyOf_i0_avatar-url"></a>10.1.1.3. Property `root > contributors > contributors items > anyOf > The first anyOf schema > avatar-url`
...
### <a name="autogenerated_heading_6"></a>13.1. root > documentation > documentation items
...
#### <a name="documentation_items_anyOf_i0"></a>13.1.1. Property `root > documentation > documentation items > anyOf > The first anyOf schema`
...
##### <a name="documentation_items_anyOf_i0_name"></a>13.1.1.1. Property `root > documentation > documentation items > anyOf > The first anyOf schema > name`
...
##### <a name="documentation_items_anyOf_i0_url"></a>13.1.1.2. Property `root > documentation > documentation items > anyOf > The first anyOf schema > url`
...
##### <a name="documentation_items_anyOf_i0_description"></a>13.1.1.3. Property `root > documentation > documentation items > anyOf > The first anyOf schema > description`
