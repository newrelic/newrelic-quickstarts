...
`;
exports.checkIfDashboardExists = graphql_request_1.gql `query dashboardSearch($query:String, $cursor:String) {
	actor {
...
`;
exports.removeDashboard = graphql_request_1.gql `mutation ($guid: EntityGuid!) {
...
`;
exports.checkIfPolicyExists = graphql_request_1.gql `query policiesSearch($accountId: Int!, $cursor: String) {
	actor {
...
`;
exports.removePolicy = graphql_request_1.gql `mutation ($accountId: Int!, $id: ID!){
