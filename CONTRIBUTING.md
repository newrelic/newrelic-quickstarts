...
# Used to reference the quickstart in URLs, should not be changed after creation.
...
```
*Note:* For a quickstart to be "installable" through New Relic, it must have an install plan.
...
> See the generated [docs](https://github.com/newrelic/newrelic-quickstarts/blob/main/docs/graphql-schema-docs.md#nr1catalogquickstartdocumentation) for more details on `documentation`
...
> See the generated [docs](https://github.com/newrelic/newrelic-quickstarts/blob/main/docs/graphql-schema-docs.md#nr1catalogquickstart) for more details on `support levels`
...
> See the generated [docs](https://github.com/newrelic/newrelic-quickstarts/blob/main/docs/graphql-schema-docs.md#nr1catalogquickstartmetadata) for more details on `icons`
...
They can define a few different types of install modes:
- `targetedInstall`
...
They can be broken out into two categories, CORE and COMMUNITY. The CORE data sources are provided by New Relic One and do *not* exist within this repository, the COMMUNITY data sources *are* defined within this repository.   

COMMUNITY data sources live in the `data-sources/` directory and *CANNOT* be nested. Example: `data-sources/example/config.yml`
